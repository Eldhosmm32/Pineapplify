...
public class AddWorker extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String name, phone;
            name = request.getParameter("workername");
            phone = request.getParameter("workerphone");
            PrintWriter out = response.getWriter();
            ManageCRUD mc = new ManageCRUD();
            HttpSession session = request.getSession();

            boolean success;
            success = mc.addWorker(name, phone, session.getAttribute("userMail").toString());
            if (success != true) {
                ...
                out.println("<script language=JavaScript>");
                out.println("$(document).ready(function(){");
                out.println("swal('Worker added Successfully','Pineapplify','success');");
                out.println("});");
                out.println("</script>");
            }
            mc.closeConnection();

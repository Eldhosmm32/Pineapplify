...
public class UpdateWorker extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        try {
            String name, phone, id, delete;
            name = request.getParameter("workername");
            phone = request.getParameter("workerphone");
            id = request.getParameter("workerid");
            delete = request.getParameter("delete");
            ManageCRUD mc = new ManageCRUD();
            HttpSession session = request.getSession();
            if (delete == null) {
                mc.updateWorker(name, phone, session.getAttribute("userMail").toString(), id);

            } else {
                mc.deleteWorker(id, session.getAttribute("userMail").toString());
            }
            mc.closeConnection();
